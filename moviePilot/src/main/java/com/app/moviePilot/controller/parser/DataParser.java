...
//	
	...
	/**
	 * Returns the param object that we want
	 * to parse and returns it as a JsonElement.
	 * @param show The show object we want to parse.
	 * @return The JsonElement that represents the Json with the desired information.
	 */
